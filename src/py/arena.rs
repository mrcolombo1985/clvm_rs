...
impl Arena {
    #[new]
    pub fn new(py: Python, to_python: PyObject) -> PyResult<Self> {
        Ok(Arena {
...
impl Arena {
    pub fn new_cell_obj(py: Python, to_python: PyObject) -> PyResult<&PyCell<Self>> {
        PyCell::new(py, Arena::new(py, to_python)?)
    }
